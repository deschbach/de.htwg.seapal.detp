$(function() {
    ...
    function loadEntry(boatnr) { 
        ...
        jQuery.get("app_boatinfo_load.jsp", {
            'bnr': boatnr
        }, function(data) {
    ...
    function addEntry(bnr, json) {
        ...
        entry += "<a href='app_trip.jsp?bnr=" + bnr + "' class='btn btn-small redirect' id='" + bnr + "'><span><i class='icon-chevron-right'></i></span></a>";
        entry += "</div></td>";
        entry += "</tr>";
    ...
    $('a.remove').on("click", function(event) {
        ...
        jQuery.post("app_boatinfo_delete.jsp", {
            "bnr": boatnr
        }, function(data) {
    ...
    $('#save').click(function(event) {
        ...
        jQuery.post("app_boatinfo_insert.jsp", json, function(data) { 
