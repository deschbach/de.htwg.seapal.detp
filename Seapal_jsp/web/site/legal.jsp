		    	...
		    	<div class="sidebar-nav">
                    ...
                    <div class="span9">
                        <div class="post" id="legal">
                            ...
                            <div class="entry">
                                <p>
                                    The developers of this web site and of the SeaPal app do not assume any liability.
                                </p>
                                <br>
                                <br>
                            </div>
