        ...
        <div class="container">
            <div class="container-fluid">
		    	...
		    	<div class="sidebar-nav">
			    	...
			    	<li class="first"><a href="userguide.jsp">User Guide</a></li>
                    ...
                    <div class="span9">
                        <div class="post">
                            ...
                            <div class="entry">
                                ...
                                <br>
                                <br>
                                <img src="../img/icons/ibn.jpg" class="img-rounded" alt="SeaPal-InitialPosition"/>
                                <figcaption>IBN Publishing House</figcaption>
                                <br>
                                <img src="../img/icons/htwg.png" class="img-rounded" alt="SeaPal-InitialPosition"/>
