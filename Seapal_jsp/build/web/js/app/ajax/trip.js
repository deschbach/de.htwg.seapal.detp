$(function() {
	...
	function loadEntry(routenr) { 
	    ...
	    jQuery.get("app_trip_load.jsp", {'tnr': routenr}, function(data) {
	...
	function addEntry(tnr, json) {
		...
		entry += "<a href='app_tripinfo.jsp?tnr=" + tnr + "' class='btn btn-small redirect' id='" + tnr + "'><span><i class='icon-chevron-right'></i></span></a>";
		entry += "</div></td>";
	    entry += "</tr>";
	...
	$('a.remove').live("click", function(event) {
		...
		jQuery.post("app_trip_delete.jsp", { "tnr": tripnr }, function(data) { 
	...
	$('#save').click(function(event) {
	    ...
	    jQuery.post("app_trip_insert.jsp", json, function(data) { 
