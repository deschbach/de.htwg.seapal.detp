...
<footer class="footer">
    <div class="container">
        ...
        <div class="span4">
            ...
            <div>
                <a href="http://itunes.apple.com/us/app/seapal/id561903907?mt=8&amp;uo=4" target="itunes_store">
                    <img src="../img/icons/seapal_normal.png" alt="Icon-Small-50" width="50" height="50"> iPad App Store
                </a>
                <br>
                <br>
                <a href="http://itunes.apple.com/us/app/seapal/id561903907?mt=8&amp;uo=4" target="itunes_store">
                    <img src="../img/icons/seapal_normal.png" alt="Icon-Small-50" width="50" height="50"> iPhone App Store
                </a>		
            </div>
        </div>
        <div class="span4">
        ...
        <div class="span4">
            ...
            <ul class="list-style2" style="list-style:none; margin-left:0px;">
                <li class="first"><a href="impressum.jsp">Impressum</a></li>
                <li><a href="legal.jsp">Legal notice</a></li>
            </ul>
        </div>
    </div>
