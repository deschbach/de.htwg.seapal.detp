...
<html prefix="og: http://ogp.me/ns#" xmlns="http://www.apple.com/itms/" lang="en">
    ...
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="keywords" content="SeaPal, Druck- und Verlagshaus Hermann Daniel GmbH &amp; Co. KG Betriebsgesellschaft, Navigation, Sports, ios apps, app, appstore, app store, iphone, ipad, ipod touch, itouch, itunes" /><meta name="description" content="Read reviews, get customer ratings, see screenshots, and learn more about SeaPal on the App Store. Download SeaPal and enjoy it on your iPhone, iPad, and iPod touch." /><meta content="SeaPal" property="og:title" /><meta content="Get SeaPal on the App Store. See screenshots and ratings, and read customer reviews." property="og:description" /><meta content="App Store" property="og:site_name" /><meta content="http://a3.mzstatic.com/us/r1000/101/Purple/v4/2a/5a/0e/2a5a0ef5-64ab-054f-2ae5-ff6529dd861f/mzl.wdjklsem.png" property="og:image" /><meta content="image/png" property="og:image:type" />
        <link rel="canonical" href="https://itunes.apple.com/us/app/seapal/id561903907?mt=8" />
        ...
        <script type="text/javascript" charset="utf-8" src="/htmlResources/E6C6/web-storefront-base.js"></script>
        <script type="text/javascript" charset="utf-8" src="/htmlResources/E6C6/web-storefront-preview.js"></script>
    ...
    <body onload="detectAndOpenItunes();" class="software geo-us">
            ...
            <div id="itunes-detector">
                ...
                <div id="itunes-client-required">
                    <div class="callout">
                        ...
                        <p preview-capable-text="We are unable to find iTunes on your computer. To download the free app SeaPal by Druck- und Verlagshaus Hermann Daniel GmbH &amp; Co. KG Betriebsgesellschaft, get iTunes now." class="intro has-preview-capable-text">
                            We are unable to find iTunes on your computer. To download the free app SeaPal by Druck- und Verlagshaus Hermann Daniel GmbH &amp; Co. KG Betriebsgesellschaft, get iTunes now.          
                        </p>
                        ...
                        <div class="download">
                            ...
                            <a href="#" onclick="javascript:window.location='http://www.apple.com/itunes/affiliates/download/?id=561903907'; return true;"><img alt="Free Download" src="/images/web/freedownload.png" /></a>
                        </div>
                ...
                <div id="content">
                    ...
                    <div class="padder">
                        ...
                        <div id="title" class="intro ">
                            <div class="left">
                                <h1>SeaPal</h1>
                                <h2>By Druck- und Verlagshaus Hermann Daniel GmbH &amp; Co. KG Betriebsgesellschaft</h2>
                            </div>
                            <div class="right">

                                <a href="https://itunes.apple.com/us/artist/druck-und-verlagshaus-hermann/id561903910" class="view-more">View More By This Developer</a>
                        ...
                        <div class="center-stack">
                            ...
                            <div more-text="More" metrics-loc="Titledbox_Description" class="product-review">
                                ...
                                <p>SeaPal is an App for sailors and other water sport fanatics that support the skipper in his tasks for navigation, route planing and logbook keeping. The central view shows a map with the current position and forward line. Waypoint and routes can easily be created, distances and courses can quickly be determined and documented in the logbook. The touch interface allows for fast and intuitive interaction. <br /><br />Online maps are available from Apple and OpenSeaMap, allong with satellite view. With these a trip can easily be planed and documented. In navigation the offline operation and the precision and depth of detail is of special importance.  Thats why digital sea maps for selected areas can be downloaded and used offline. <br /><br />For the area of the Lake Constance excellent sea maps and local information (harbours, shipyards, shops, restaurants) provided by the IBN publishing house are available as extensions. Further areas are in preparation.<br />The application was developed particularly for the iPad in a cooperation between the IBN publishing house and the HTWG Constance University. The specific advantages of a mobile device and the touch interface were taken into account just as well as the special requirements of sailors and skippers. As a result of this cooperation, SeaPal is made available for free. Extensions and sea maps can be purchased and loaded according to your area and needs.<br /><br />This cooperation is open to further extension. Should you be interested to develop or provide further extensions, please contact us. <br /><br />The application runs on the iPad and with reduced functionality on the iPhone. An iPad with 3G or 4G and GPS is recommended. For longer use an external power source (like a USP port of a radio) is required. <br /><br />Function overview:<br />Apple Maps<br />OpenSeaMaps<br />Satellite view<br />Follow position<br />Position from GPS always visible in the map view<br />Course and speed always visible in the map view<br />Free navigation on the map with swipe and pinch<br />Fast return to the current position<br />Route planing, waypoints are editable<br />Automatic waypoint switching<br />Bearing and distance to any particular point with long-touch<br />Placing of permanent marks on the map<br />Add marks using bearing or coordinates<br />Select any mark as target   <br />Bearing and distance to current target always visible in the map view<br />Distance measurement, even across several waypoints<br />“Person over Board” functionality<br /><br />With extensions:<br />Logbook function for one or several boats<br />Automatic tracking<br />Automatic or manual logbook entries<br />Fotos for logbook entries<br />Collection of regional Points of Interest<br /><br />Warning: SeaPal is a valuable addition to your navigational equipment, but no replacement. Always use official sea maps in conjunction. All positions are provided so that a transition to paper sea maps is simple. The responsibility for the proper use lies with the skipper. The manufacturer of SeaPal assume no liability.</p>
                            ...
                            <div class="app-links"><a rel="nofollow" target="_blank" href="http://www.seapal.de" class="see-all">Druck- und Verlagshaus Hermann Daniel GmbH &amp; Co. KG Betriebsgesellschaft Web Site</a><a rel="nofollow" target="_blank" href="https://www.ibn-online.de/software/support?id=8" class="see-all">SeaPal Support</a></div>


                            <div more-text="More" metrics-loc="Titledbox_What&#39;s New in Version 1.1" class="product-review">
                                ...
                                <p>SeaPal is supporting iOS 5 now</p>
                            ...
                            <div metrics-loc="Swoosh_" rows="1" class="swoosh lockup-container application large screenshots">
                                ...
                                <div num-items="4" class="content ipad-screen-shots"><div><div class="lockup"><img alt="iPad Screenshot 1" class="landscape" src="http://a1314.phobos.apple.com/us/r1000/065/Purple/v4/06/27/4e/06274ee3-b006-45dd-dfea-e32855570b1c/mzl.lmbmgfdy.480x480-75.jpg" /></div><div class="lockup"><img alt="iPad Screenshot 2" class="landscape" src="http://a654.phobos.apple.com/us/r1000/101/Purple/v4/4b/95/96/4b9596e0-e569-e439-10f3-85e4bfd02116/mzl.yiyngajj.480x480-75.jpg" /></div><div class="lockup"><img alt="iPad Screenshot 3" class="landscape" src="http://a636.phobos.apple.com/us/r1000/071/Purple/v4/76/4f/b4/764fb48c-0063-e866-c840-87d1a0a3329e/mzl.iomuargt.480x480-75.jpg" /></div><div class="lockup"><img alt="iPad Screenshot 4" class="landscape" src="http://a151.phobos.apple.com/us/r1000/115/Purple/v4/62/f1/73/62f17364-0598-0b4d-562c-231d0d81e7e9/mzl.gnfeawup.480x480-75.jpg" /></div></div></div>
                            ...
                            <div metrics-loc="Swoosh_" rows="1" class="swoosh lockup-container application large">
                                ...
                                <div num-items="5" class="content"><div>
                                        <div rating-software="100,itunes-games" parental-rating="1" role="group" metrics-loc="Lockup_" adam-id="495210783" preview-artist="Helge Staedtler" aria-label="OpenSeaMap" preview-title="OpenSeaMap" class="lockup small application">

                                            <a href="https://itunes.apple.com/us/app/openseamap/id495210783?mt=8" class="artwork-link"><div class="artwork"><img width="100" height="100" alt="OpenSeaMap" class="artwork" src="http://a2.mzstatic.com/us/r1000/085/Purple/7e/f7/93/mzl.dyeovoyf.100x100-75.jpg" /><span class="mask"></span></div></a>

                                            <div class="lockup-info">



                                                <ul role="presentation" class="list"><li><a href="https://itunes.apple.com/us/app/openseamap/id495210783?mt=8" class="name">OpenSeaMap</a></li><li><a href="https://itunes.apple.com/us/genre/ios-navigation/id6010?mt=8" class="genre">Navigation</a></li><li><a onclick="return its.detect.openItunes(&#39;https://itunes.apple.com/us/app/openseamap/id495210783?mt=8&#39;);" href="#" class="action view-in-itunes"><span>View In iTunes</span></a></li></ul>
                                            </div>
                                        </div>

                                        <div rating-software="100,itunes-games" parental-rating="1" role="group" metrics-loc="Lockup_" adam-id="370885968" preview-artist="Imray" aria-label="Marine Imray Charts" preview-title="Marine Imray Charts" class="lockup small application">

                                            <a href="https://itunes.apple.com/us/app/marine-imray-charts/id370885968?mt=8" class="artwork-link"><div class="artwork"><img width="100" height="100" alt="Marine Imray Charts" class="artwork" src="http://a4.mzstatic.com/us/r1000/116/Purple/v4/81/34/f8/8134f8d4-4386-3bdd-ca60-79c8e356eea5/mzl.ysychnkj.100x100-75.jpg" /><span class="mask"></span></div></a>

                                            <div class="lockup-info">



                                                <ul role="presentation" class="list"><li><a href="https://itunes.apple.com/us/app/marine-imray-charts/id370885968?mt=8" class="name">Marine Imray Charts</a></li><li><a href="https://itunes.apple.com/us/genre/ios-navigation/id6010?mt=8" class="genre">Navigation</a></li><li><a onclick="return its.detect.openItunes(&#39;https://itunes.apple.com/us/app/marine-imray-charts/id370885968?mt=8&#39;);" href="#" class="action view-in-itunes"><span>View In iTunes</span></a></li></ul>
                                            </div>
                                        </div>

                                        <div rating-software="100,itunes-games" parental-rating="1" role="group" metrics-loc="Lockup_" adam-id="409794756" preview-artist="Navionics" aria-label="Marine: Europe HD" preview-title="Marine: Europe HD" class="lockup small application">

                                            <a href="https://itunes.apple.com/us/app/marine-europe-hd/id409794756?mt=8" class="artwork-link"><div class="artwork"><img width="100" height="100" alt="Marine: Europe HD" class="artwork" src="http://a2.mzstatic.com/us/r1000/104/Purple/v4/b2/73/6c/b2736c85-d09d-aa81-fc9b-cb5b0bfd54f2/mzl.ipqxgxkf.100x100-75.jpg" /><span class="mask"></span></div></a>

                                            <div class="lockup-info">



                                                <ul role="presentation" class="list"><li><a href="https://itunes.apple.com/us/app/marine-europe-hd/id409794756?mt=8" class="name">Marine: Europe HD</a></li><li><a href="https://itunes.apple.com/us/genre/ios-navigation/id6010?mt=8" class="genre">Navigation</a></li><li><a onclick="return its.detect.openItunes(&#39;https://itunes.apple.com/us/app/marine-europe-hd/id409794756?mt=8&#39;);" href="#" class="action view-in-itunes"><span>View In iTunes</span></a></li></ul>
                                            </div>
                                        </div>

                                        <div rating-software="100,itunes-games" parental-rating="1" role="group" metrics-loc="Lockup_" adam-id="398456162" preview-artist="Transas Marine Limited" aria-label="Transas iSailor" preview-title="Transas iSailor" class="lockup small application">

                                            <a href="https://itunes.apple.com/us/app/transas-isailor/id398456162?mt=8" class="artwork-link"><div class="artwork"><img width="100" height="100" alt="Transas iSailor" class="artwork" src="http://a3.mzstatic.com/us/r1000/068/Purple/v4/ab/6d/0f/ab6d0f2c-9ddb-f20f-7f8e-5dfddd0713cd/mzl.bhcooszq.100x100-75.jpg" /><span class="mask"></span></div></a>

                                            <div class="lockup-info">



                                                <ul role="presentation" class="list"><li><a href="https://itunes.apple.com/us/app/transas-isailor/id398456162?mt=8" class="name">Transas iSailor</a></li><li><a href="https://itunes.apple.com/us/genre/ios-navigation/id6010?mt=8" class="genre">Navigation</a></li><li><a onclick="return its.detect.openItunes(&#39;https://itunes.apple.com/us/app/transas-isailor/id398456162?mt=8&#39;);" href="#" class="action view-in-itunes"><span>View In iTunes</span></a></li></ul>
                                            </div>
                                        </div>

                                        <div rating-software="100,itunes-games" parental-rating="1" role="group" metrics-loc="Lockup_" adam-id="416877198" preview-artist="Deutsche Bahn" aria-label="DB Navigator for iPad" preview-title="DB Navigator for iPad" class="lockup small application">

                                            <a href="https://itunes.apple.com/us/app/db-navigator-for-ipad/id416877198?mt=8" class="artwork-link"><div class="artwork"><img width="100" height="100" alt="DB Navigator for iPad" class="artwork" src="http://a3.mzstatic.com/us/r1000/074/Purple/v4/c5/f5/d5/c5f5d58c-3e26-dcf8-b16c-86b300b6af3b/mzm.xhlbsayq.100x100-75.jpg" /><span class="mask"></span></div></a>

                                            <div class="lockup-info">



                                                <ul role="presentation" class="list"><li><a href="https://itunes.apple.com/us/app/db-navigator-for-ipad/id416877198?mt=8" class="name">DB Navigator for iPad</a></li><li><a href="https://itunes.apple.com/us/genre/ios-travel/id6003?mt=8" class="genre">Travel</a></li><li><a onclick="return its.detect.openItunes(&#39;https://itunes.apple.com/us/app/db-navigator-for-ipad/id416877198?mt=8&#39;);" href="#" class="action view-in-itunes"><span>View In iTunes</span></a></li></ul>
                                            </div>
                                        </div>
                                    </div></div>
                        ...
                        <div id="left-stack">
                            ...
                            <div rating-software="100,itunes-games" parental-rating="1" class="lockup product application">
                                <a href="https://itunes.apple.com/us/app/seapal/id561903907?mt=8"><div class="artwork"><img width="175" height="175" alt="SeaPal" class="artwork" src="http://a3.mzstatic.com/us/r1000/101/Purple/v4/2a/5a/0e/2a5a0ef5-64ab-054f-2ae5-ff6529dd861f/mzl.wdjklsem.175x175-75.jpg" /><span class="mask"></span></div></a>
                                <a onclick="return its.detect.openItunes(&#39;https://itunes.apple.com/us/app/seapal/id561903907?mt=8&#39;);" href="#" class="action view-in-itunes"><span>View In iTunes</span></a>
                                <ul class="list"><li><div class="price">Free</div></li><li class="genre"><span class="label">Category: </span><a href="https://itunes.apple.com/us/genre/ios-navigation/id6010?mt=8">Navigation</a></li><li class="release-date"><span class="label">Updated: </span>Oct 05, 2012</li><li><span class="label">Version: </span>1.1</li><li><span class="label">Size: </span>1.7 MB</li><li class="language"><span class="label">Languages: </span>English, German</li><li><span class="label">Seller: </span>Druck- und Verlagshaus Hermann Daniel GmbH &amp; Co. KG Betriebsgesellschaft</li><li class="copyright">© 2012 Druck- und Verlagshaus Hermann Daniel GmbH &amp; Co KG</li></ul><div class="app-rating"><a href="http://itunes.apple.com/WebObjects/MZStore.woa/wa/appRatings">Rated 4+</a></div><p><span class="app-requirements">Requirements: </span>Compatible with iPad. Requires iOS 5.0 or later.</p>
                            </div>
        ...
        <script type="text/javascript">itms.PageData.itunesDownloadUrl='http://www.apple.com/itunes/affiliates/download/?id=561903907';</script>
                ...
                <div id="directorynav" class="itunes">
                    ...
                    <div id="dn-colc" class="column">
                        ...
                        <ul>
                            ...
                            <li><a href="http://www.apple.com/education/volume-purchase-program/">App Store Volume Purchase</a></li>
                        </ul>
                    </div>
        ...
        <script language="JavaScript" type="text/javascript"><!--
            ...
            var iTSMetricsCallbackFunction = function() {
                ...
                /* Page Metrics */
                ITSMetrics.omniture.pageName="SEO-Software-US-Druck- und Verlagshaus Hermann Daniel GmbH & Co. KG Betriebsgesellschaft-SeaPal-561903907";
                ITSMetrics.omniture.channel="SEO";
                ITSMetrics.omniture.prop22="HTML";
                ITSMetrics.omniture.eVar22="HTML";
                ITSMetrics.omniture.products="Druck- und Verlagshaus Hermann Daniel GmbH & Co. KG Betriebsgesellschaft-SeaPal-561903907";
